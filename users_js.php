...
adduser=function(){
	...
	?>
	if (!gid('userrole_<?php echo $role;?>_'+suffix)) {alert('Settings outdated; please reload your screen to continue;');return;}
	if (gid('userrole_<?php echo $role;?>_'+suffix).checked) groupnames.push('<?php echo $role;?>');
	<?php
	}
	?>
	}
